...
if "__main__" == __name__:
    ...
    parser.add_argument(
        "--checkpoint",
        type=str,
        default="pretrained_weights/marigold-v1-0",
    ...
    input_rgb_dir = os.path.join(args.data_dir, args.phase, "input",  args.vid_name)
    output_dir = os.path.join(args.data_dir, args.phase, "input",  args.vid_name+'_marigolddepth')
    ...
    # -------------------- Preparation --------------------
    # Output directories
    output_dir_color = os.path.join(output_dir)
